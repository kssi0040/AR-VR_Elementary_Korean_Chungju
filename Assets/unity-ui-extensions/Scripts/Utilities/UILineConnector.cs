namespace UnityEngine.UI.Extensions
{
    ...
    public class UILineConnector : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            society_Quiz2 = FindObjectOfType<Language_Quiz2>();
        }
        ...
        void Update()
        {
            ...
            if (isInitialized) //if (m_LineRenderer.Length == 0)
            {
                ...
                Debug.Log("m_LineRenderer.Length: " + m_LineRenderer.Length);
                /*
                for (int i = 0; i < m_LineRenderer.Length; i++)
			    {
                    Debug.Log("transform.GetChild: " + transform.GetChild(i));
